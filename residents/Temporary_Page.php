...
$residentPhoneNumber = isset($_SESSION['pending_resident_phone_number']) ? $_SESSION['pending_resident_phone_number'] : '';
$residentId = $_SESSION['pending_resident_id'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_message'])) {
    ...
    if (empty($message) && !$filePath) {
        ...
        if ($sent) {
            header("Location: Temporary_Page.php?admin_id=" . $receiverId);
            exit;
        } else {
...
<main class="container pending-container">
    <div class="pending-card">
        ...
        <div class="info-box">
            ...
            <p><?php echo htmlspecialchars($residentPhoneNumber); ?></p>
        </div>

        <p class="contact-note">
            If you have any questions or concerns, please contact the barangay office directly or use the chat below.
        </p>

        <!-- Messaging Section -->
        <div class="messages-section" style="margin-top: 2rem;">
            <h2 style="color: var(--primary-green, #2c7a2c); margin-bottom: 1rem; border-bottom: 2px solid var(--accent-yellow, #ffc107); padding-bottom: 0.5rem;">💬 Chat with Administrators</h2>
                    ...
                    <div class="conversations-list">
                        ...
                        <?php else: ?>
                            <?php foreach ($allAdmins as $admin): ?>
                                ...
                                ?>
                                <a href="Temporary_Page.php?admin_id=<?php echo $admin['id']; ?>" 
                        ...
                        <div class="chat-input-area">
                            <form method="POST" class="chat-form" enctype="multipart/form-data">
                                ...
                                <div class="chat-input-wrapper">
                                    <label for="chat_file_temp_<?php echo $selectedAdminId; ?>" class="file-upload-btn" title="Upload image or video">
                                        📎
                                    </label>
                                    <input type="file" id="chat_file_temp_<?php echo $selectedAdminId; ?>" name="chat_file" accept="image/*,video/*" style="display: none;">
                                ...
                                <div id="file-preview-temp-<?php echo $selectedAdminId; ?>" class="file-preview"></div>
                            </form>
                        </div>
                    <?php else: ?>
...
<script>
    ...
    var filePreview = document.getElementById('file-preview-temp-' + selectedAdminId);
