      ...
      if (!in_array($idFileType, $allowedTypes)) {
        ...
        try {
          ...
          if ($checkStmt->rowCount() > 0) {
            ...
            if ($stmt->rowCount() > 0) {
              $success = "Registration successful! Your account is being reviewed by barangay officials. You'll be able to log in once approved.";
              echo '<script>
                alert("Registration successful!\\n\\nYour account is being reviewed by barangay officials.\\nYou will be able to log in once your account is approved.\\n\\nThank you for your patience!");
...
<main class="container auth-page">
  <div class="auth-card">
    ...
    <?php if(!empty($error)): ?>
      <p style="color: red; padding: 10px; background: #ffe6e6; border-radius: 5px; margin-bottom: 15px;"><?php echo htmlspecialchars($error); ?></p>
    <?php endif; ?>
    <?php if(!empty($success)): ?>
      <p style="color: green; padding: 10px; background: #e6ffe6; border-radius: 5px; margin-bottom: 15px;"><?php echo htmlspecialchars($success); ?></p>
    <?php endif; ?>
